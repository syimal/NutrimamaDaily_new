...
class HealthyFoodAdapter(private val foodList: List<String>) : RecyclerView.Adapter<HealthyFoodAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.activity_item_healthy_food, parent, false)
